...
const filterAndLoadResults = () => {
    ...
    const request = new Request(`http://localhost:3004/filtermusic?genre=${genre}&artist=${artist}&title=${title}&albulm=${albulm}`);
...
const handleFavoriteClick = (id) => {
    ...
    const request = new Request(`http://localhost:3004/favorite?id=${id}`);
    var song = null;
